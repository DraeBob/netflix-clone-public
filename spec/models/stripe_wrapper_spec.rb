...
describe StripeWrapper::Customer do
  ...
  context "with valid card" do
    ...
    it "charges the card successfully", :vcr do
      response = StripeWrapper::Customer.create(plan: "premium", card: token, email: 'example@example.com')
  ...
  context "with invalid card" do
    ...
    let(:response){ StripeWrapper::Customer.create(plan: "premium", card: token, email: 'example@example.com') }
